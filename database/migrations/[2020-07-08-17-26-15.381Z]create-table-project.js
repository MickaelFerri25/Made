...
const up = (migration) => {
   ...
   newTable.addField('picture', 'varchar').length(50);
   newTable.addField('designLink', 'varchar').length(255).allowNull();
   newTable.addField('rules', 'longtext');
   newTable.addField('isPublished', 'boolean');
   newTable.addField('publishedAt', 'datetime').allowNull();
   newTable.addField('level', 'smallint');
